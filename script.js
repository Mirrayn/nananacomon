 ...
 const datosCarrerasBurbuja = [
    ...
    x: item.x,
    y: item.y,
    r: 10, // Define el radio visible de cada burbuja
    name: item.name
}));
...
new Chart(document.getElementById("otro"), {
    ...
    data: {
        datasets: [{
            ...
            data: datosCarrerasBurbuja,
            backgroundColor: "rgba(44, 230, 7, 0.55)",
            borderColor: "rgb(187, 17, 31)",
            borderWidth: 1
        }]
    },
    options: {
        ...
        plugins: {
            legend: {
                position: 'top',
                labels: { font: { family: "'Georama', sans-serif" } }
            },
            title: {
                display: true,
                text: 'Chart.js Bubble Chart',
                font: { family: "'Georama', sans-serif", size: 14 }
            },
            tooltip: {
        ...
        scales: {
            ...
            y: {
                grid: { color: "rgba(253, 253, 253, 0.06)" },
                border: { color: "#262730", dash: [4, 4] },
                ticks: {
                    font: { family: "'Georama', sans-serif", size: 11 },
                    color: "#413c53",
                    callback: function (value) {
